...
public class TestCaseDirectory {
    ...
    private static ConcurrentHashMap<String, TestCase> initializeDirectory() {
        ...
        directory.put("3.1.220",
                new TestCase(ADVANCED, "3.1.220", "Flow Rule ID Spoofing", "Test for controller protection against " +
                        "Flow Rule ID Spoofing attack"));
        directory.put("3.1.230",
                new TestCase(ADVANCED, "3.1.230", "Infinite Flow Rule Synchronization", "Test for controller protection against " +
                        "Infinite Flow Rule Synchronization attack"));
        directory.put("3.1.240",
                new TestCase(ADVANCED, "3.1.240", "Malformed Flow Rule Generation", "Test for controller protection against " +

...
import org.deltaproject.manager.utils.OFMessageEncoder;
...
public class OFChannelInitializer extends ChannelInitializer<Channel> {
	...
	protected void initChannel(Channel ch) throws Exception {
		...
		OFChannelHandler newhandler = new OFChannelHandler(pipeline, timer, ofBitmaps, defaultFactory, testHandShake);
